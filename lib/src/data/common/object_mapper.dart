...
import 'package:your_app_test/src/data/dto/appointment_dto.dart';
...
import 'package:your_app_test/src/data/dto/last_health_scan_dto.dart';
import 'package:your_app_test/src/data/dto/medical_record_dto.dart';
import 'package:your_app_test/src/data/dto/medical_record_file_dto.dart';
...
import 'package:your_app_test/src/data/dto/prescribed_dto.dart';
import 'package:your_app_test/src/data/dto/prescribed_element_dto.dart';
...
import 'package:your_app_test/src/data/dto/share_record_with_doctor_dto.dart';
import 'package:your_app_test/src/data/dto/subscription_dto.dart';
import 'package:your_app_test/src/data/dto/token_dto.dart';
import 'package:your_app_test/src/domain/domain.dart';
import 'package:your_app_test/src/domain/extension/let_extension.dart';
import 'package:your_app_test/src/domain/extension/list_extension.dart';
...
import 'package:your_app_test/src/domain/model/medical_record_file.dart';
...
import 'package:your_app_test/src/domain/model/precribed_element.dart';
import 'package:your_app_test/src/domain/model/prescribed.dart';
import 'package:your_app_test/src/domain/model/prescription.dart';
import 'package:your_app_test/src/domain/model/shared_with_doctors.dart';
import 'package:your_app_test/src/domain/model/subscription.dart';
...
class ObjectMapper {
  ...
  BaseResponseDto<TeamDto> toGetTeam(BaseResponseDto<TeamDto> dto) {
    return BaseResponseDto<TeamDto>(
      ...
      data: TeamDto(
          data: dto.data!.data
              .map((e) => DepartmentDto(team: e.team, department: e.department))
              .toList()),
    );
  }
}
