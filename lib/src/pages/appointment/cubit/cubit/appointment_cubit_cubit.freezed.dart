...
/// @nodoc
abstract class $AppointmentCubitStateCopyWith<$Res> {
  factory $AppointmentCubitStateCopyWith(AppointmentCubitState value,
          $Res Function(AppointmentCubitState) then) =
      _$AppointmentCubitStateCopyWithImpl<$Res, AppointmentCubitState>;
}

/// @nodoc
class _$AppointmentCubitStateCopyWithImpl<$Res,
        $Val extends AppointmentCubitState>
    implements $AppointmentCubitStateCopyWith<$Res> {
  _$AppointmentCubitStateCopyWithImpl(this._value, this._then);
...
class __$$_InitialCopyWithImpl<$Res>
    extends _$AppointmentCubitStateCopyWithImpl<$Res, _$_Initial>
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'AppointmentCubitState.initial()';
  }
...
class __$$_SelectedDateCopyWithImpl<$Res>
    extends _$AppointmentCubitStateCopyWithImpl<$Res, _$_SelectedDate>
...
class _$_SelectedDate implements _SelectedDate {
  const _$_SelectedDate(this.selectedDate);
  ...
  @override
  String toString() {
    return 'AppointmentCubitState.selectedDate(selectedDate: $selectedDate)';
  }
...
abstract class _SelectedDate implements AppointmentCubitState {
  const factory _SelectedDate(final DateTime? selectedDate) = _$_SelectedDate;
...
class __$$_SelectedTimeCopyWithImpl<$Res>
    extends _$AppointmentCubitStateCopyWithImpl<$Res, _$_SelectedTime>
...
class _$_SelectedTime implements _SelectedTime {
  const _$_SelectedTime(this.selectedTime);
  ...
  @override
  String toString() {
    return 'AppointmentCubitState.selectedTime(selectedTime: $selectedTime)';
  }
...
abstract class _SelectedTime implements AppointmentCubitState {
  const factory _SelectedTime(final String? selectedTime) = _$_SelectedTime;
...
/// @nodoc
abstract class _$$_SelectedReasonForAppointmentCopyWith<$Res> {
  factory _$$_SelectedReasonForAppointmentCopyWith(
          _$_SelectedReasonForAppointment value,
          $Res Function(_$_SelectedReasonForAppointment) then) =
      __$$_SelectedReasonForAppointmentCopyWithImpl<$Res>;
  @useResult
  $Res call({String? selectedReason});
}

/// @nodoc
class __$$_SelectedReasonForAppointmentCopyWithImpl<$Res>
    extends _$AppointmentCubitStateCopyWithImpl<$Res,
        _$_SelectedReasonForAppointment>
    implements _$$_SelectedReasonForAppointmentCopyWith<$Res> {
  __$$_SelectedReasonForAppointmentCopyWithImpl(
      _$_SelectedReasonForAppointment _value,
      $Res Function(_$_SelectedReasonForAppointment) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SelectedReasonForAppointment(
      freezed == selectedReason
...
class _$_SelectedReasonForAppointment implements _SelectedReasonForAppointment {
  const _$_SelectedReasonForAppointment(this.selectedReason);
  ...
  @override
  String toString() {
    return 'AppointmentCubitState.selectedReasonForAppointment(selectedReason: $selectedReason)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SelectedReasonForAppointment &&
  ...
  _$$_SelectedReasonForAppointmentCopyWith<_$_SelectedReasonForAppointment>
      get copyWith => __$$_SelectedReasonForAppointmentCopyWithImpl<
          _$_SelectedReasonForAppointment>(this, _$identity);
...
abstract class _SelectedReasonForAppointment implements AppointmentCubitState {
  const factory _SelectedReasonForAppointment(final String? selectedReason) =
      _$_SelectedReasonForAppointment;
