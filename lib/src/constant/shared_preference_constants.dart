class SharedPreferenceConstants {
  static const String user = 'user_Nb';
  static const String apiAuthToken = 'apiAuthToken_Nb';
  static const String isLoggedIn = 'isLoggedIn_Nb';
  static const String binahSessionInitiated = 'binahSessionInitiated';
